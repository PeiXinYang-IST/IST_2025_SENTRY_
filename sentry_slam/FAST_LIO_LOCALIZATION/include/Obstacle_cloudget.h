...
class Obstacle_cloud_get
{
    ...
    void processed_pointCloudCallback(const sensor_msgs::PointCloud2ConstPtr& msg);
    private:
    ...
    float clear_x_;
    float clear_y_;
    float static_inflate_distance_;
    float dynamic_inflate_distance_;
    ...
    ros::Subscriber processed_cloud_sub_;
