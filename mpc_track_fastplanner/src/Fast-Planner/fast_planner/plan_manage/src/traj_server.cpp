...
Eigen::Vector3d real_cmd_vel(0,0,0);
...
{
  // real_cmd_vel(0)=cmd_vel.linear.x;
  // real_cmd_vel(1)=cmd_vel.linear.y;
  // real_cmd_vel(1)=cmd_vel.angular.z;
}
...
int main(int argc, char** argv) {
  ...
  ros::Subscriber cmd_vel_sub = node.subscribe("/cmd_vel", 50, cmdvelCallback);
