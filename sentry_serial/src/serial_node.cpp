...
void cmd_vel_callback(const geometry_msgs::Twist& cmd_vel)
{
	...
	serial_package.linear_x = cmd_vel_x*1.0;
    serial_package.linear_y = cmd_vel_y*1.0;
...
{  
    ...
    ros::Subscriber pid_sub = nh.subscribe("pid_follow/pid_cmd_vel", 1000, cmd_vel_callback); 
    ros::spin();
}